...
(function ($) {
	...
	$.widget("wijmo.wijlineargauge", $.wijmo.wijgauge, {
		...
		_paintLabel: function (value, labelInfo) {
			...
			textEle.attr(style);
			$.wijchart.addClass($(textEle.node), "wijmo-wijlineargauge-label");
			return textEle;
		},
		...
		_paintMark: function (value, opt, isMajor) {
			...
			$.wijchart.addClass($(markEle.node), "wijmo-wijlineargauge-mark");
		...
		_paintFace: function () {
			...
			$.wijchart.addClass($(face.node), "wijmo-wijlineargauge-face");
			return face;
		},
		...
		_paintPointer: function () {
			...
			$.wijchart.addClass($(pointer.node), "wijmo-wijlineargauge-pointer");
		...
		_setLinearPointer: function (fromValue, endValue, value) {
			...
			if (animation.enabled) {
				self.pointer
					.wijAnimate({ translation: translation.x + "," + translation.y },
					animation.duration, animation.easing);
			}
			else {
				self.pointer.attr("translation", translation.x + "," + translation.y);
			}
		},
		...
		_drawRange: function (coercedFrom, coercedTo, startDistance, endDistance,
			...
			$.wijchart.addClass($(rangeEl.node), "wijmo-wijlineargauge-range");
