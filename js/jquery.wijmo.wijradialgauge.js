...
(function ($) {
	...
	$.widget("wijmo.wijradialgauge", $.wijmo.wijgauge, {
		...
		_paintMark: function (value, opt, isMajor) {
			...
			mark = self._paintMarkEle(opt);
			mark.attr(opt.style);
			$.wijchart.addClass($(mark.node), "wijmo-wijradialgauge-mark");
		...
		_paintLabel: function (value, labelInfo) {
			...
			textEle.attr(style);
			$.wijchart.addClass($(textEle.node), "wijmo-wijradialgauge-label");
			return textEle;
		},
		...
		_paintFace: function () {
			...
			$.wijchart.addClass($(face.node), "wijmo-wijradialgauge-face");
			return face;
		},
		...
		_paintPointer: function () {
			...
			self.pointer = point;
			$.wijchart.addClass($(point.node), "wijmo-wijradialgauge-pointer");
		...
		_paintCap: function () {
			...
			$.wijchart.addClass($(self.cap.node), "wijmo-wijradialgauge-cap");
			return self.cap;
			//
		},
		...
		_drawRange: function (from, to, startDistance, endDistance,
			...
			$.wijchart.addClass($(rangeEl.node), "wijmo-wijradialgauge-range");
		},
		...
		_setPointer: function () {
			...
			if (animation.enabled) {
				self.pointer.wijAnimate({ rotation: angle + "," + self.centerPoint.x +
					"," + self.centerPoint.y
